...
static TaskHandle_t Task1, Task2, Task3, Task4, Task5, MainTask;

#define EVENT_GET_LAST_CUT_OK 1 << 0
#define EVENT_CONTINUE_OK 1 << 1
#define EVENT_REQUEST_OK 1 << 2

#define EVENT_TASK1_OK 1 << 3
#define EVENT_TASK2_OK 1 << 4
#define EVENT_TASK3_OK 1 << 5
#define EVENT_TASK4_OK 1 << 6
#define EVENT_TASK5_OK 1 << 7
#endif